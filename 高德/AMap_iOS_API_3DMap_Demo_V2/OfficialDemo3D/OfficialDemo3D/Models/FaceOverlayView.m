...
- (void)drawCircleWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount
{
    ...
    /* Drawing internal. */
    [self renderRegionWithPoints:points pointCount:pointCount fillColor:self.fillColor strokeLineWidth:[self glWidthForWindowWidth:self.lineWidth] usingTriangleFan:YES];
