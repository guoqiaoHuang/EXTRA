...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        switch (indexPath.row)
        {
            ...
            case 17  : title = @"所属商圈";         break;
            case 18  : title = @"扩展信息";          break;
            case 19  : title = @"行业深度信息";       break;
            case 20  : title = @"动态市场信息";       break;
            default  :  break;
        }
    }
...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        switch (indexPath.row)
        {
            ...
            case 17 : subTitle = self.poi.businessArea;         break;
            case 18 : subTitle = nil;                           break;
            case 19 : subTitle = nil;                           break;
            case 20 : subTitle = nil;                           break;
            default : break;
        }
    }
