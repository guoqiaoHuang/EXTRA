...
- (void)onInterphoneStateWithReason:(NSInteger)reason andConfNo:(NSString*)confNo
{
    ...
    else
    {
        ...
        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"加入对讲失败，请稍后重试" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
        [alertView show];
        [alertView release];
    }
}
