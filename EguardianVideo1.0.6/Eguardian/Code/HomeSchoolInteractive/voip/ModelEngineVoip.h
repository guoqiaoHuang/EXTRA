...
@property (nonatomic,retain) NSString* type; //群组类型 0：临时组(上限100人)  1：普通组(上限300人)  2：VIP组 (上限500人)
...
@property (nonatomic, retain) NSString *sid;//用户的VoIP账号
@property (nonatomic, retain) NSString *display;//用户名字
@property (nonatomic, retain) NSString *sex;//用户性别
@property (nonatomic, retain) NSString *birth;//用户生日
@property (nonatomic, retain) NSString *tel;//用户电话
@property (nonatomic, retain) NSString *sign;//用户的签名信息
...
@property (nonatomic, retain) NSString *display;//用户名字
@property (nonatomic, retain) NSString *voipAccount;//用户Voip账号
@property (nonatomic, retain) NSString *tel;//用户电话
@property (nonatomic, retain) NSString *mail;//用户邮箱
@property (nonatomic, retain) NSString *remark;//用户备注
@property (nonatomic, retain) NSString *belong;//用户所属的群组ID
@end
...
//设置推送的设备token
- (NSInteger)setVoipDeviceToken:(NSString *)token;
//延时呼叫，处理多路打来排队进入
