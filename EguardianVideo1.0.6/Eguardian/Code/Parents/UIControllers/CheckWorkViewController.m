...
@interface CheckWorkViewController ()
...
-(void)selectDateFinish
{
    ...
    NSString *tempURL = [ConfigManager getCheckWorkWithString:[NSString stringWithDate:self.date]];
...
{
    CheckWorkData *cdata = [[CheckWorkData alloc] initWithDictionary: [JSONProcess JSONProcess:tempData]];
